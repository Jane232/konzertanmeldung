...
if (isset($_GET["show"])) { // Je nach Menü-Auswahl werden verschiedene Ifs ausgeführt
        ...
        */
        ...
        if (isset($_POST["send"])) {// Wenn Auswahl der Liste schon getroffen, dann:
            ...
            if (file_exists($linkToTab.preg_replace('/\s+/', '', $_POST["event"]).".csv")) {// Wenn Tabelle existiert, dann
                ...
                echo "<center>Diese Tabelle ($eventName) existiert noch nicht <br><br> <a href='index.php?show=lists'>Zurück zur Listenübersicht</a></center>";
            }
